...
FIELD_PRESENTATIONS: dict[str, FieldPresentationSpec] = {
    ...
    "orbit": FieldPresentationSpec("Orbit", "indicator", 63),
    "reviewDate": FieldPresentationSpec("Review date", "date", 64),
    "snoozedUntil": FieldPresentationSpec("Snoozed until", "datetime", 65),
    "permanentSnoozeUntil": FieldPresentationSpec("Permanent snooze time", "time", 66),
